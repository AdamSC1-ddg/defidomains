...
export class DappRegistrarController extends SmartContract {
  static bind(address: Address): DappRegistrarController {
    return new DappRegistrarController("DappRegistrarController", address);
  }
