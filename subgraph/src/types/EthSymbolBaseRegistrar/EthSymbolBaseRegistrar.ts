...
export class ethsymbolBaseRegistrar extends SmartContract {
  static bind(address: Address): ethsymbolBaseRegistrar {
    return new ethsymbolBaseRegistrar("ethsymbolBaseRegistrar", address);
  }
