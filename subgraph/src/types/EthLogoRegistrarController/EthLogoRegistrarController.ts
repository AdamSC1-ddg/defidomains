...
export class EthLogoRegistrarController extends SmartContract {
  static bind(address: Address): EthLogoRegistrarController {
    return new EthLogoRegistrarController(
      "EthLogoRegistrarController",
      address
    );
  }
