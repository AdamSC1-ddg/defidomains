...
export class YamRegistrarController extends SmartContract {
  static bind(address: Address): YamRegistrarController {
    return new YamRegistrarController("YamRegistrarController", address);
  }
