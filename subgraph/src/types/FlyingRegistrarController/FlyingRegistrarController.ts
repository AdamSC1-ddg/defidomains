...
export class FlyingRegistrarController extends SmartContract {
  static bind(address: Address): FlyingRegistrarController {
    return new FlyingRegistrarController("FlyingRegistrarController", address);
  }
