...
export class dappBaseRegistrar extends SmartContract {
  static bind(address: Address): dappBaseRegistrar {
    return new dappBaseRegistrar("dappBaseRegistrar", address);
  }
