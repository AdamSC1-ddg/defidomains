...
export class NFTRegistrarController extends SmartContract {
  static bind(address: Address): NFTRegistrarController {
    return new NFTRegistrarController("NFTRegistrarController", address);
  }
