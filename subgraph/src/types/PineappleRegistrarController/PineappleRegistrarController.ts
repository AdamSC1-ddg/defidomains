...
export class PineappleRegistrarController extends SmartContract {
  static bind(address: Address): PineappleRegistrarController {
    return new PineappleRegistrarController(
      "PineappleRegistrarController",
      address
    );
  }
