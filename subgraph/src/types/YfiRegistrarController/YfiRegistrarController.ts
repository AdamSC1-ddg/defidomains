...
export class yfiRegistrarController extends SmartContract {
  static bind(address: Address): yfiRegistrarController {
    return new yfiRegistrarController("yfiRegistrarController", address);
  }
