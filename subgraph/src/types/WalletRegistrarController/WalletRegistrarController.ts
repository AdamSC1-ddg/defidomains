...
export class WalletRegistrarController extends SmartContract {
  static bind(address: Address): WalletRegistrarController {
    return new WalletRegistrarController("WalletRegistrarController", address);
  }
