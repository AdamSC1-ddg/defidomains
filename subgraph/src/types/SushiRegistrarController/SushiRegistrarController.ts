...
export class SushiRegistrarController extends SmartContract {
  static bind(address: Address): SushiRegistrarController {
    return new SushiRegistrarController("SushiRegistrarController", address);
  }
