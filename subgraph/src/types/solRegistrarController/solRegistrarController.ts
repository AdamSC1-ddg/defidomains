...
export class SolRegistrarController extends SmartContract {
  static bind(address: Address): SolRegistrarController {
    return new SolRegistrarController("SolRegistrarController", address);
  }
