...
export class BearBaseRegistrar extends SmartContract {
  static bind(address: Address): BearBaseRegistrar {
    return new BearBaseRegistrar("BearBaseRegistrar", address);
  }
