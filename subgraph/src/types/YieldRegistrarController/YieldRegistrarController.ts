...
export class yieldRegistrarController extends SmartContract {
  static bind(address: Address): yieldRegistrarController {
    return new yieldRegistrarController("yieldRegistrarController", address);
  }
