...
export class UnicornBaseRegistrar extends SmartContract {
  static bind(address: Address): UnicornBaseRegistrar {
    return new UnicornBaseRegistrar("UnicornBaseRegistrar", address);
  }
