...
export class DaoRegistrarController extends SmartContract {
  static bind(address: Address): DaoRegistrarController {
    return new DaoRegistrarController("DaoRegistrarController", address);
  }
