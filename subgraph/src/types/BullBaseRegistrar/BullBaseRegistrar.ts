...
export class BullBaseRegistrar extends SmartContract {
  static bind(address: Address): BullBaseRegistrar {
    return new BullBaseRegistrar("BullBaseRegistrar", address);
  }
