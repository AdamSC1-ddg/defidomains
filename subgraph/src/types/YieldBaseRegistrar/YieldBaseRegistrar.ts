...
export class YieldBaseRegistrar extends SmartContract {
  static bind(address: Address): YieldBaseRegistrar {
    return new YieldBaseRegistrar("YieldBaseRegistrar", address);
  }
