...
export class PineappleBaseRegistrar extends SmartContract {
  static bind(address: Address): PineappleBaseRegistrar {
    return new PineappleBaseRegistrar("PineappleBaseRegistrar", address);
  }
