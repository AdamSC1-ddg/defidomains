...
export class defiBaseRegistrar extends SmartContract {
  static bind(address: Address): defiBaseRegistrar {
    return new defiBaseRegistrar("defiBaseRegistrar", address);
  }
