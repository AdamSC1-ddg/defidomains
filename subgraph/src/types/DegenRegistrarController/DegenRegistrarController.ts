...
export class DegenRegistrarController extends SmartContract {
  static bind(address: Address): DegenRegistrarController {
    return new DegenRegistrarController("DegenRegistrarController", address);
  }
