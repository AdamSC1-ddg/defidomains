...
export class EthLogoBaseRegistrar extends SmartContract {
  static bind(address: Address): EthLogoBaseRegistrar {
    return new EthLogoBaseRegistrar("EthLogoBaseRegistrar", address);
  }
