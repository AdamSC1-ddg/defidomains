...
export class NameMigrated extends Entity {
  ...
  save(): void {
    ...
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save NameMigrated entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("NameMigrated", id.toString(), this);
  }

  static load(id: string): NameMigrated | null {
    return store.get("NameMigrated", id) as NameMigrated | null;
  }
