...
export class EthSymbolRegistrarController extends SmartContract {
  static bind(address: Address): EthSymbolRegistrarController {
    return new EthSymbolRegistrarController(
      "EthSymbolRegistrarController",
      address
    );
  }
