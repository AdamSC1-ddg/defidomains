...
export class BullRegistrarController extends SmartContract {
  static bind(address: Address): BullRegistrarController {
    return new BullRegistrarController("BullRegistrarController", address);
  }
