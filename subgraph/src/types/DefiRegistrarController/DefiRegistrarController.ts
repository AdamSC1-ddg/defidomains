...
export class defiRegistrarController extends SmartContract {
  static bind(address: Address): defiRegistrarController {
    return new defiRegistrarController("defiRegistrarController", address);
  }
