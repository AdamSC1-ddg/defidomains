...
export class UnicornRegistrarController extends SmartContract {
  static bind(address: Address): UnicornRegistrarController {
    return new UnicornRegistrarController(
      "UnicornRegistrarController",
      address
    );
  }
