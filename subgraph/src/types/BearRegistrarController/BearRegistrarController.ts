...
export class BearRegistrarController extends SmartContract {
  static bind(address: Address): BearRegistrarController {
    return new BearRegistrarController("BearRegistrarController", address);
  }
