...
export class SushiBaseRegistrar extends SmartContract {
  static bind(address: Address): SushiBaseRegistrar {
    return new SushiBaseRegistrar("SushiBaseRegistrar", address);
  }
