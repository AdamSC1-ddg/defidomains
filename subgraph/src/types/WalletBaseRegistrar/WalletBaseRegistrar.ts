...
export class WalletBaseRegistrar extends SmartContract {
  static bind(address: Address): WalletBaseRegistrar {
    return new WalletBaseRegistrar("WalletBaseRegistrar", address);
  }
