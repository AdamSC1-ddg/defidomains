...
export class DegenBaseRegistrar extends SmartContract {
  static bind(address: Address): DegenBaseRegistrar {
    return new DegenBaseRegistrar("DegenBaseRegistrar", address);
  }
