...
} from './types/DefiBaseRegistrar/DefiBaseRegistrar'

import {
  NameRegistered as ControllerNameRegisteredEvent
} from './types/DefiRegistrarController/DefiRegistrarController'
...
var rootNode: ByteArray = byteArrayFromHex("0xe23c1845b96c0c4b37fbb545b38cff2fe0449edb1df7e34390454e19d697616b")
...
export function handleNameRegisteredByController(event: ControllerNameRegisteredEvent): void {
  ...
  if (domain.labelName !== event.params.name) {
    ...
    domain.name = event.params.name + '.defi'
    domain.save()
  }
}
