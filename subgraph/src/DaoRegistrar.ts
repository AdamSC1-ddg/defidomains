...
} from './types/DaoBaseRegistrar/DaoBaseRegistrar'

import {
  NameRegistered as ControllerNameRegisteredEvent
} from './types/DaoRegistrarController/DaoRegistrarController'
...
var rootNode:ByteArray = byteArrayFromHex("0xb5f2bbf81da581299d4ff7af60560c0ac854196f5227328d2d0c2bb0df33e553")
...
export function handleNameRegisteredByController(event: ControllerNameRegisteredEvent): void {
  ...
  if(domain.labelName !== event.params.name) {
    ...
    domain.name = event.params.name + '.dao'
    domain.save()
  }
}
