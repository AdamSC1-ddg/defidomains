...
} from './types/SolBaseRegistrar/SolBaseRegistrar'

import {
  NameRegistered as ControllerNameRegisteredEvent
} from './types/SolRegistrarController/SolRegistrarController'
...
var rootNode:ByteArray = byteArrayFromHex("0x572e8cce9cadb272410b9b1a01685fdb2609411afed0c7f12324c7bb1bd5c911")
...
export function handleNameRegisteredByController(event: ControllerNameRegisteredEvent): void {
  ...
  if(domain.labelName !== event.params.name) {
    ...
    domain.name = event.params.name + '.sol'
    domain.save()
  }
}
