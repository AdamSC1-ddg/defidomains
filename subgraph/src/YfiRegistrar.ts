...
} from './types/YfiBaseRegistrar/YfiBaseRegistrar'

import {
  NameRegistered as ControllerNameRegisteredEvent
} from './types/YfiRegistrarController/YfiRegistrarController'
...
var rootNode:ByteArray = byteArrayFromHex("0x63cebbf94831c06713075eaa6cb223ad20b4cedd4f9f4f04b74bc96e46f45bf7")
...
export function handleNameRegisteredByController(event: ControllerNameRegisteredEvent): void {
  ...
  if(domain.labelName !== event.params.name) {
    ...
    domain.name = event.params.name + '.yfi'
    domain.save()
  }
}
